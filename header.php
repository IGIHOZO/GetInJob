                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        <div class="nav-item dropdown dropright">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Man power <i class="fa fa-angle-right float-right mt-1"></i></a>
                            <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                <a href="" class="dropdown-item">Heavy weights</a>
                                <a href="" class="dropdown-item">Contruction</a>
                                <a href="" class="dropdown-item">Transportation</a>
                            </div>
                        </div>
                        <a href="" class="nav-item nav-link">Accounting</a>
                        <a href="" class="nav-item nav-link">Telecomunication</a>
                        <a href="" class="nav-item nav-link">Computer Science</a>
                        <a href="" class="nav-item nav-link">Electricity</a>
                        <a href="" class="nav-item nav-link">Driver</a>
                        <a href="" class="nav-item nav-link">Construction</a>
                        <a href="" class="nav-item nav-link">Chemistry</a>
                        <a href="" class="nav-item nav-link">Laboratorians</a>
                        <a href="" class="nav-item nav-link">Consultancy</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                         ...
                         <!--    <a href="shop" class="nav-item nav-link">Login</a>
                            ...
                            <a href="index#scorers" class="nav-item nav-link">Top Scorers</a>
                            <a href="index#recent" class="nav-item nav-link">Recent</a>
                            <a href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                            <a href="index#partners" class="nav-item nav-link">Partners</a>
